...
exports.CalendarEventModule = CalendarEventModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([calendar_event_entity_1.CalendarEvent]), calendar_share_module_1.CalendarShareModule, event_invitation_module_1.EventInvitationModule],
